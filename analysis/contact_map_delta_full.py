...
def plot_contact_matrix(date,minute):
    ...
    fig.savefig("./results/"+date+"/contact_map_delta_cg"+str(CG)+date+"_"+minute+"_full.png", dpi=300)
...
for i in range(0,79,1):
    calculate_contact_matrix('Oct27',str(i))
    plot_contact_matrix('Oct27',str(i))
